...
if __name__ == "__main__":
    # 标签的位置
    annotation_path = '/content/drive/MyDrive/Colab Notebooks/Yolo_v4/dataset/train_txt/anno.txt'
    # 获取classes和anchor的位置
    classes_path = '/content/drive/MyDrive/Colab Notebooks/Yolo_v4/model_data/bccd_classes.txt'    
    ...
    #   预测的东西都不一样了自然维度不匹配
    #------------------------------------------------------#
    weights_path = '/content/drive/MyDrive/Colab Notebooks/Yolo_v4/yolo4_weight.h5'
    # 获得classes和anchor
    ...
    # 训练后的模型保存的位置
    log_dir = '/content/drive/MyDrive/Colab Notebooks/Yolo_v4/'
    # 输入的shape大小
    # 显存比较小可以使用416x416
    # 现存比较大可以使用608x608
    input_shape = (416,416)
